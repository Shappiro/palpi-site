# flake8: noqa
"""
Django settings for progetto_alpi project.
...
DJANGO_ROOT = root.path('progetto_alpi')
...
ROOT_URLCONF = 'progetto_alpi.urls'
...
WSGI_APPLICATION = 'progetto_alpi.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///progetto_alpi'),
}
...
WAGTAIL_SITE_NAME = "Progetto Alpi"
